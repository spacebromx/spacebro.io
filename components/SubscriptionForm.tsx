const SubscriptionForm = () => {
  return (
    <div className="text-center px-4 lg:px-0">
      <form>
        <p className="text-4xl lg:text-5xl font-bold leading-snug mb-8 bg-clip-text text-transparent bg-gradient-to-bl from-teal-900 to-yellow-300">
          Amazing content,
          <br />
          on your mailbox
        </p>
        ...
        <input
          ...
          className="w-3/5 lg:w-1/4 px-4 py-2 bg-gray-300 border border-gray-800 rounded-tl-md rounded-bl-md outline-none focus:outline-none focus:ring focus:border-pink-300 placeholder-gray-500"
        />
        <input
          type="submit"
          value="Sign up"
