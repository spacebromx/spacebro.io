  ...
  return (
    <html>
      ...
      <body>
        ...
        <div className="container mx-auto bg-purple-800 sticky top-0 opacity-90 bg-purple-800 flex flex-col h-16 items-center flex-row backdrop-blur-xl md:backdrop-filter-none z-10">
